...
/**
 * 1.[LeetCode,636] Given the running logs of n functions that are executed in a
 ...
 * function 0 ends to the very end of time 0.
 ...
 * Now function 0 calls function 1, function 1 starts at time 2, executes 4 units of time and end at
 * time 5.
 * Function 0 is running again at time 6, and also end at the time 6, thus executes 1 unit of time.
 * So function 0 totally execute 2 + 1 = 3 units of time, and function 1 totally execute 4 units of time.
 * Note:
 * 1. Input logs will be sorted by timestamp, NOT log id.
 * 2. Your output should be sorted by function id, which means the 0th element of
 * your output corresponds to the exclusive time of function 0.
 * 3. Two functions won't start or end at the same time.
 * 4. Functions could be called recursively, and will always end.
 * 5. 1 <= n <= 100
 * 地址：
 * http://www.1point3acres.com/bbs/forum.php?mod=viewthread&tid=425013&extra=page%
